...
Сервер повторно проверяет роль и связанную учётную запись, поэтому смена роли в
браузере или подстановка чужого идентификатора не даёт доступ к операции.
